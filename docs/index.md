...
| [Target](target.md)                                 | Which app, which party, which destination, and the optional instance template |
| [Payload](payload.md)                               | The data elements to post, from an example, a file, or by hand                |
| [Posting](posting.md)                               | What each destination calls, repeating a post, and max count behaviour        |

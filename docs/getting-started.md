...
3. Press **Probe app**. The data type picker and the party picker now come from the app itself.
...
2. **Target.** Type an org and app, press **Probe app**, and pick a party the token is allowed to instantiate for. See [Target](target.md).
